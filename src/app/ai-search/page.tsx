...
export default function AISearchPage() {
        ...
        <div className="overflow-hidden rounded-[28px] border border-neutral-200 bg-[#f5f3ee] shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
          <div className="px-8 py-12 md:px-12 lg:px-16 lg:py-16">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl font-black leading-[0.95] tracking-tight md:text-6xl xl:text-7xl">
                FIND YOUR
                <br />
              ...
              <p className="mt-6 max-w-xl text-sm leading-6 text-neutral-500 md:text-base">
            ...
            <div className="mt-6 flex max-w-3xl flex-wrap gap-3 text-sm">
              {examplePrompts.map((example) => (
                <button
                  key={example}
                  onClick={() => handleSearch(example)}
                  className="rounded-full border border-neutral-300 bg-white px-3 py-2 text-xs text-neutral-700 transition hover:border-neutral-400 hover:bg-neutral-50"
                >
                  {example}
                </button>
              ))}
  ...
  <div className="overflow-hidden rounded-[32px] border border-neutral-200 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
